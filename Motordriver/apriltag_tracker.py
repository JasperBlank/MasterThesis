...
def create_detector(family: str) -> object:
    ...
    # The endoscopes illuminate a small central area and leave a strong
    # brightness gradient.  A wider adaptive-threshold range keeps the
    # 10.62 mm tags detectable near the darker image edges.
